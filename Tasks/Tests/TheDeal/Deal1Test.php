...
final class Deal1Test extends Deal1
{
    protected function getContainer(): ContainerInterface
    {
        ...
        $container->register('circular_a', A::class)->addMethodCall('setB', [new Reference('circular_b')]);
        $container->register('circular_b', B::class)->addMethodCall('setC', [new Reference('circular_c')]);
        $container->register('circular_c', C::class)->addMethodCall('setA', [new Reference('circular_a')]);
